...
For the most updated guide you should refer to the Expo docs: [Using Next.js](https://docs.expo.dev/guides/using-nextjs). Here are the [latest docs on master](https://github.com/expo/expo/edit/master/docs/pages/guides/using-nextjs.md).
