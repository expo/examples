...
- Open the project in a React runtime to try it:
  - iOS: [Expo client iOS](https://itunes.apple.com/app/apple-store/id982107779)
  - Android: [Expo client Android](https://play.google.com/store/apps/details?id=host.exp.exponent&referrer=blankexample)
  - Web: Any web browser
...
- You can still run your project in the Expo client, you just won't be able to access any new native modules you add.
...
- Learn more about [Universal React with Expo](https://docs.expo.io/).
